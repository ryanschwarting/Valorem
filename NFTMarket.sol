...
contract NFTMarketplace is ReentrancyGuard, Ownable {
    ...
    uint256 listingPrice = 0.025 ether; //price for people to list NFT on our marketplace
    ...
    function createMarketSale(address nftContract, uint256 itemId) public payable nonReentrant{
        ...
        idMarketItem[itemId].sold = payable(msg.sender); //mark that it has been sold
    ...
    /// @notice total number of items sold unsold on our platform
    function fetchMarketItems() public view returns (MarketItem[] memory ){
        ...
        return items; //return an array of all unsold items
    }
    ...
    function fetchMyNFTs() public view returns (MarketItem[] memory) {
        ...
        for (uint256 i = 0; i < totalItemCount; i++){
            //get only the items that this user owns or bought
     ...
     /// @notice fetch list of items created
